 ...
 */
public class UniversalQ extends AbstractUnaryOperation {

    private String variable;

    public UniversalQ(String var, Operation op) {
        variable = var;
        operation = op;
    }
    ...
    public OperationType getType() {
        return OperationType.UNIVERSAL_Q;
    }
    ...
    public Operation replaceVariable(String v, Operation op) {
        return new UniversalQ(variable, operation.replaceVariable(v, op));
    }
